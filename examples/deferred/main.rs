...
use gfx::handle::{ShaderResourceView, DepthStencilView};
...
fn create_g_buffer<R: gfx::Resources, F: gfx::Factory<R>>(width: texture::Size,
                                                          height: texture::Size,
                                                          factory: &mut F)
                                                          -> (ViewPair<R, GFormat>,
                                                              ViewPair<R, GFormat>,
...
impl<R: gfx::Resources> gfx_app::Application<R> for App<R> {
    fn new<F: gfx::Factory<R>>(factory: &mut F,
        ...
        let sampler = factory
            .create_sampler(texture::SamplerInfo::new(texture::FilterMethod::Scale,
