...
pub enum Request {
    ...
    CallNewMesh(mesh::VertexCount, Vec<f32>),
...
impl Client {
    ...
    pub fn create_mesh(&self, num_vert: mesh::VertexCount, data: Vec<f32>) -> MeshHandle {
        ...
        loop {
            match self.stream.try_recv() {
                ...
                Ok(CallNewMesh(num_vert, data)) => {
                    ...
                    let mut mesh = MeshHandle::new(num_vert, self.array_buffer);
