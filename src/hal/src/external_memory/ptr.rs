...
impl From<(ExternalMemoryPtrType, Ptr, u64)> for ExternalMemoryPtr {
...
impl Into<(ExternalMemoryPtrType, Ptr, u64)> for ExternalMemoryPtr {
...
impl From<ExternalMemoryPtr> for ExternalMemory {
    fn from(external_memory_ptr: ExternalMemoryPtr) -> Self {
