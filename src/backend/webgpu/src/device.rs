...
impl hal::device::Device<Backend> for Device {
    ...
    unsafe fn create_external_buffer(
        ...
        size: u64,
    ) -> Result<<Backend as hal::Backend>::Buffer, hal::external_memory::ExternalBufferCreateError> {unimplemented!()}
    ...
    unsafe fn allocate_exportable_memory(
        ...
        size: u64,
    ) -> Result<<Backend as hal::Backend>::Memory, hal::external_memory::ExternalMemoryAllocateError> {unimplemented!()}
