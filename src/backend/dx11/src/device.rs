...
impl device::Device<Backend> for Device {
    ...
    unsafe fn create_image_view(
        ...
        let info = ViewInfo {
            ...
            layers: range.layer_start .. range.layer_start + range.resolve_layer_count(image.kind.num_layers()),
            levels: range.level_start .. range.level_start + range.resolve_level_count(image.kind.num_levels()),
        };
