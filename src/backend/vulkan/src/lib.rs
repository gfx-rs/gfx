...
impl hal::PhysicalDevice<Backend> for PhysicalDevice {
    ...
    fn limits(&self) -> Limits {
        ...
        Limits {
            max_1d_texture_size: limits.max_image_dimension1d,
            max_2d_texture_size: limits.max_image_dimension2d,
            max_3d_texture_size: limits.max_image_dimension3d,
            max_cube_texture_size: limits.max_image_dimension_cube,
            ...
            max_sampler_count: limits.max_sampler_allocation_count,
            buffer_granularity: limits.buffer_image_granularity,
            sparse_address_space_size: limits.sparse_address_space_size,
            max_bound_descriptor_sets: limits.max_bound_descriptor_sets,
            max_samplers_per_stage: limits.max_per_stage_descriptor_samplers,
            ...
            max_sampled_images_per_stage: limits.max_per_stage_descriptor_sampled_images,
            max_storage_images_per_stage: limits.max_per_stage_descriptor_storage_images,
            max_input_attachments_per_stage: limits.max_per_stage_descriptor_input_attachments,
            max_resources_per_stage: limits.max_per_stage_resources,
            max_samplers_per_pipeline: limits.max_descriptor_set_samplers,
            max_uniform_buffers_per_pipeline: limits.max_descriptor_set_uniform_buffers,
            max_dynamic_uniform_buffers_per_pipeline: limits.max_descriptor_set_uniform_buffers_dynamic,
            max_storage_buffers_per_pipeline: limits.max_descriptor_set_storage_buffers,
            max_dynamic_storage_buffers_per_pipeline: limits.max_descriptor_set_storage_buffers_dynamic,
            max_sampled_images_per_pipeline: limits.max_descriptor_set_sampled_images,
            max_storage_images_per_pipeline: limits.max_descriptor_set_storage_images,
            max_input_attachments_per_pipeline: limits.max_descriptor_set_input_attachments,
            ...
            max_generation_level: limits.max_tessellation_generation_level,
            max_patch_size: limits.max_tessellation_patch_size,
            max_tesselation_control_input_components_per_vertex: limits.max_tessellation_control_per_vertex_input_components,
            max_tesselation_control_output_components_per_vertex: limits.max_tessellation_control_per_vertex_output_components,
            max_tesselation_control_output_components_per_patch: limits.max_tessellation_control_per_patch_output_components,
            max_tesselation_control_output_components_total: limits.max_tessellation_control_total_output_components,
            max_tesselation_evaluation_input_components: limits.max_tessellation_evaluation_input_components,
            max_tesselation_evaluation_output_components: limits.max_tessellation_evaluation_output_components,
            ...
            max_geometry_output_components_total: limits.max_geometry_total_output_components,
            ...
            max_fragment_output_attachment_dual_src: limits.max_fragment_dual_src_attachments,
            max_fragment_output_resources: limits.max_fragment_combined_output_resources,
            max_compute_shared_memory_size: limits.max_compute_shared_memory_size,
            max_compute_group_count: limits.max_compute_work_group_count,
            max_compute_group_invocations: limits.max_compute_work_group_invocations,
            max_compute_group_size: limits.max_compute_work_group_size,
            ...
            max_draw_index_value: limits.max_draw_indexed_index_value,
            ...
            texel_offset_bounds: limits.min_texel_offset,
            texel_gather_offset_bounds: limits.max_texel_offset,
            interpolation_offset_bounds: limits.min_texel_gather_offset,
            sub_pixel_interpolation_offset_bits: limits.max_texel_gather_offset,
            max_framebuffer_dimensions: limits.min_interpolation_offset,
            framebuffer_color_sample_counts: limits.max_interpolation_offset,
            framebuffer_depth_sample_counts: limits.sub_pixel_interpolation_offset_bits,
            framebuffer_stencil_sample_counts: limits.max_framebuffer_width,
            framebuffer_none_sample_counts: limits.max_framebuffer_height,
            max_subpass_color_attachments: limits.max_framebuffer_layers,
            sampled_image_color_sample_counts: limits.framebuffer_color_sample_counts as _,
            sampled_image_integer_sample_counts: limits.framebuffer_depth_sample_counts as _,
            sampled_image_depth_sample_counts: limits.framebuffer_stencil_sample_counts as _,
            sampled_image_stencil_sample_counts: limits.framebuffer_no_attachments_sample_counts as _,
            storage_image_sample_counts: limits.max_color_attachments as _,
            max_sample_mask_words: limits.sampled_image_color_sample_counts as _,
            all_compute_and_graphics_support_timestamps: limits.sampled_image_integer_sample_counts as _,
            timestamp_precision: limits.sampled_image_depth_sample_counts as _,
            max_clip_distances: limits.sampled_image_stencil_sample_counts as _,
            max_cull_distances: limits.storage_image_sample_counts as _,
            max_clip_cull_distances_total: limits.max_sample_mask_words,
            discrete_queue_priorities: limits.timestamp_compute_and_graphics,
            point_size_range: limits.timestamp_period,
            line_width_range: limits.max_clip_distances,
            point_size_granularity: limits.max_cull_distances,
            line_width_granularity: limits.max_combined_clip_and_cull_distances,
            is_strict_lines: limits.discrete_queue_priorities,
            is_standard_sampler_locations: limits.point_size_range,
            optimal_buffer_copy_offset_alignment: (limits.line_width_range[0])..=(limits.line_width_range[1]),
            optimal_buffer_copy_pitch_alignment: limits.point_size_granularity,
            non_coherent_atom_size: limits.line_width_granularity,
        }
    }
}
