...
pub fn map_vk_surface_transform_flags(
    vk_flags: vk::SurfaceTransformFlagsKHR,
) -> hal::display::SurfaceTransformFlags {
    let mut flags = hal::display::SurfaceTransformFlags::empty();
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::IDENTITY) {
        flags.insert(hal::display::SurfaceTransformFlags::IDENTITY);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::ROTATE_90) {
        flags.insert(hal::display::SurfaceTransformFlags::ROTATE_90);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::ROTATE_180) {
        flags.insert(hal::display::SurfaceTransformFlags::ROTATE_180);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::ROTATE_270) {
        flags.insert(hal::display::SurfaceTransformFlags::ROTATE_270);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR) {
        flags.insert(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR_ROTATE_90) {
        flags.insert(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR_ROTATE_90);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR_ROTATE_180) {
        flags.insert(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR_ROTATE_180);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR_ROTATE_270) {
        flags.insert(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR_ROTATE_270);
    }
    if vk_flags.contains(vk::SurfaceTransformFlagsKHR::INHERIT) {
        flags.insert(hal::display::SurfaceTransformFlags::INHERIT);
    }
    flags
}

pub fn map_surface_transform_flags(
    flags: hal::display::SurfaceTransformFlags,
) -> vk::SurfaceTransformFlagsKHR {
    let mut vk_flags = vk::SurfaceTransformFlagsKHR::empty();

    if flags.contains(hal::display::SurfaceTransformFlags::IDENTITY) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::IDENTITY;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::ROTATE_90) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::ROTATE_90;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::ROTATE_180) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::ROTATE_180;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::ROTATE_270) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::ROTATE_270;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR_ROTATE_90) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR_ROTATE_90;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR_ROTATE_180) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR_ROTATE_180;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::HORIZONTAL_MIRROR_ROTATE_270) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::HORIZONTAL_MIRROR_ROTATE_270;
    }
    if flags.contains(hal::display::SurfaceTransformFlags::INHERIT) {
        vk_flags |= vk::SurfaceTransformFlagsKHR::INHERIT;
    }
    vk_flags
}
