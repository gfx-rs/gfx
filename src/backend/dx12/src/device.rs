...
impl d::Device<B> for Device {
    ...
    unsafe fn create_external_buffer(
        ...
        size: u64,
    ) -> Result<r::Buffer, hal::external_memory::ExternalBufferCreateError> {unimplemented!()}
    ...
    unsafe fn allocate_exportable_memory(
        ...
        mem_type: hal::MemoryTypeId,
        size: u64,
    ) -> Result<r::Memory, hal::external_memory::ExternalMemoryAllocateError> {unimplemented!()}
