    ...
    fn enumerate_adapters(&self) -> Vec<hal::Adapter<Backend>> {
        ...
        loop {
            ...
            let physical_device = PhysicalDevice {
                ...
                limits: Limits {
                    max_1d_texture_size: d3d12::D3D12_REQ_TEXTURE1D_U_DIMENSION,
                    max_2d_texture_size: d3d12::D3D12_REQ_TEXTURE2D_U_OR_V_DIMENSION,
                    max_3d_texture_size: d3d12::D3D12_REQ_TEXTURE3D_U_V_OR_W_DIMENSION,
                    max_cube_texture_size: d3d12::D3D12_REQ_TEXTURECUBE_DIMENSION,
                    max_array_layers: d3d12::D3D12_REQ_TEXTURE2D_ARRAY_AXIS_DIMENSION, // TODO: could differ from 1D
                    ...
                    // TODO: query supported sample count for all framebuffer formats and increase the limit if possible.
                    ...
                    max_clip_distances: d3d12::D3D12_CLIP_OR_CULL_DISTANCE_COUNT,
                    max_cull_distances: d3d12::D3D12_CLIP_OR_CULL_DISTANCE_COUNT,
                    max_clip_cull_distances_total: d3d12::D3D12_CLIP_OR_CULL_DISTANCE_COUNT,
