...
use hal::device::{BindError, OutOfMemory, ShaderError, AllocationError, DeviceLost, OomOrDeviceLost};
...
impl hal::Device<Backend> for Device {
    ...
    fn create_sampler(&self, info: image::SamplerInfo) -> Result<n::Sampler, OutOfMemory> {
    ...
    fn create_swapchain(
        ...
        Ok(self.build_swapchain(surface, config))
    }
